...
function findWasmBinary() {
  return locateFile('keshipin.wasm');
}
...
var ASM_CONSTS = {
  96400: () => { if (document.fullscreenElement) return 1; },  
 96446: () => { return document.getElementById('canvas').width; },  
 96498: () => { return parseInt(document.getElementById('canvas').style.width); },  
 96566: () => { document.exitFullscreen(); },  
 96593: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 96666: () => { if (document.fullscreenElement) return 1; },  
 96712: () => { return document.getElementById('canvas').width; },  
 96764: () => { return screen.width; },  
 96789: () => { document.exitFullscreen(); },  
 96816: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 96949: () => { return window.innerWidth; },  
 96975: () => { return window.innerHeight; },  
 97002: () => { if (document.fullscreenElement) return 1; },  
 97048: () => { return document.getElementById('canvas').width; },  
 97100: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97168: () => { if (document.fullscreenElement) return 1; },  
 97214: () => { return document.getElementById('canvas').width; },  
 97266: () => { return screen.width; },  
 97291: () => { return window.innerWidth; },  
 97317: () => { return window.innerHeight; },  
 97344: () => { if (document.fullscreenElement) return 1; },  
 97390: () => { return document.getElementById('canvas').width; },  
 97442: () => { return screen.width; },  
 97467: () => { document.exitFullscreen(); },  
 97494: () => { if (document.fullscreenElement) return 1; },  
 97540: () => { return document.getElementById('canvas').width; },  
 97592: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97660: () => { document.exitFullscreen(); },  
 97687: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 97745: () => { return screen.width; },  
 97770: () => { return screen.height; },  
 97796: () => { return window.screenX; },  
 97823: () => { return window.screenY; },  
 97850: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 97903: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 97974: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 98031: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 98287: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 98358: () => { if (document.fullscreenElement) return 1; },  
 98404: () => { return window.innerWidth; },  
 98430: () => { return window.innerHeight; },  
 98457: () => { if (document.pointerLockElement) return 1; }
};
